...
<body onload="loadedSidebar()">
    <div class="col-3 px-0 bg-light shadow-lg">
        <div id="sideMenu" class="d-flex flex-column">
            <button class="px-3 d-block py-2 hoverable  border-0" onclick="activateLink(event)" name="dashboard">Dashboard</button>
            <button class="px-3 d-block py-2 hoverable  border-0" onclick="activateLink(event)" name="courses">Courese</button>
            <button class="px-3 d-block py-2 hoverable  border-0" onclick="activateLink(event)">Lessons</button>
            <button name="students" class="px-3 d-block py-2 hoverable  border-0" onclick="activateLink(event)">Students</button>
