            ...
            <div class="col-6 d-none d-md-block my-auto px-4">
                <svg class="img-fluid" id="becd4ed6-983c-4267-a9ef-ba1a19b5a08b" data-name="Layer 1"
                    ...
                    <path
                        ...
                        transform="translate(-226.3946 -164.99667)" fill="#e6e6e6" />
                    <path
                        ...
                        transform="translate(-226.3946 -164.99667)" fill="#fff" />
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-226.3946 -164.99667)" fill="#2f2e41" />
                    <path
                        ...
                        transform="translate(-226.3946 -164.99667)" fill="#ffb9b9" />
                    <path
